        ...
        <script src="assets/js/scripts.js"></script>
            ...
            <div class="row">
              <div class="col-sm-2 col-sm-offset-1">
                <button class="btn1" onclick="visitPage();" style="height: 120px;"><h1 style="color: white; font-size: 25px;">Report Generation<br> per product per team</h1></button>
              </div>



              <div class="col-sm-2 col-sm-offset-5">
                <button class="btn1" onclick="visitPage2();" style="height: 120px;"><h1 style="color: white; font-size: 25px;">Report generation<br> per team</h1></button>
              </div>
