    ...
    <head>
        ...
        <script src="assets/js/scripts.js"></script>
            ...
            <div class="row">
             ...
             <div class="row">
              <div class="col-sm-4 col-sm-offset-4">
                <button class="btn1" onclick="visitPage();"><h1 style="color: white; font-size: 25px;">Sales data <br> entry</h1></button>
              </div>
              <!--<div class="col-sm-3 col-sm-offset-1">
                <button class="btn1"><h1 style="color: white; font-size: 25px;">Send mail to team leader/members</h1></button>
              </div>
              </div>
              <br><br>-->
          ...
          <br><br>
            ...
            <script>
              function visitPage(){
              window.location='sales_entry.php';
              }
</script>